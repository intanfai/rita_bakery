...
export default function ProductDetailPage() {
  ...
  const handleAddToCart = () => {
    // Sementara ini placeholder — nanti kita sambungin ke CartContext di langkah berikutnya
    console.log({
      product,
    ...
    alert('Ditambahkan ke keranjang (sementara masih console.log, belum tersimpan beneran)')
  }
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-4">
        ...
        <div>
          ...
          {!product.is_available && (
            <p className="text-red-600 text-sm mt-1">Maaf, produk ini sedang tidak tersedia.</p>
          )}
                ...
                {product.variants.map((variant) => (
                  ...
                  >
                    ...
                    {Number(variant.extra_price) > 0 &&
                      ` (+${formatRupiah(variant.extra_price)})`}
                  </button>
                ))}
              </div>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-9 h-9 border rounded-lg text-gray-700"
              >
                −
              </button>
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              placeholder="Misal: tulis 'Happy Birthday Sarah' di atas kue"
